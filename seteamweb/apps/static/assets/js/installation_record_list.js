async function fetchAndRenderData() {
    // API 호출
    const response = await fetch('/customer/record-list-api');
        ...
        pageData.forEach(item => {
            ...
            const row = `
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info pdf-view-btn" data-name="${item.name}" pdf-view-url="/customer/record-cert/view">View</button>
                        <button class="btn btn-info download-btn" data-name="${item.name}" pdf-download-url="/customer/record-cert/download">Download</button>
                    </td>
                </tr>
            `;
